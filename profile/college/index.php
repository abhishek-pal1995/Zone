...
<head>
    ...
    <title>Zone | <?php echo $clg_name; ?></title>
                ...
                <div class="profile user-profile">
                    ...
                    <div class="profiles_content">
                        ...
                        <div class="profile_info">
                            ...
                            <p style="text-align: center;"> <?php echo $clg_uname; ?> </p>
                        </div>
                    ...
                    <div class="flex justify-between lg:border-t border-gray-100 flex-col-reverse lg:flex-row pt-2">
                        <nav class="responsive-nav pl-3">
                            <ul uk-switcher="connect: #timeline-tab; animation: uk-animation-fade">
                                ...
                                <li><a href="#">Members <span><?php echo getTotal($row['college_id']) ?></span> </a></li>
                ...
                <div class="uk-switcher lg:mt-8 mt-4" id="timeline-tab">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <nav class="responsive-nav border-b">
                            <ul uk-switcher="connect: #members-tab; animation: uk-animation-fade">
                                <li><a href="#" class="lg:px-2"> All Members <span><?php echo getTotal($row['college_id']); ?></span> </a></li>
                                <li><a href="#" class="lg:px-2"> Native Students </a></li>
                                <li><a href="#" class="lg:px-2"> Pending Requests </a></li>
                            </ul>
                        </nav>

                        <div class="uk-switcher lg:mt-8 mt-4" id="members-tab">
                            ...
                            <div>
                                <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-x-2 gap-y-4 mt-3">
                                    ...
                                    $stmt = $link->prepare("SELECT * FROM `zone_users` WHERE `college_id` = ?");
                                    ...
                                    ?>
                                        ...
                                        <div class="card p-2">
                                            <a href="../../user/<?php echo $row['zone_id']; ?>">
                                            ...
                                            <div class="pt-3 px-1">
                                                ...
                                                <p class="font-medium text-sm"> <?php echo $row['uname']; ?> </p>
                                    ...
                                    $stmt = $link->prepare("SELECT * FROM `college_connections` WHERE `college_id` = ? AND `status` = ?");
                                    $stmt->bind_param("is", $_SESSION['college_id'], $status);
                                    ...
                                    ?>
                                        ...
                                        <div class="card p-2">
                                            <a href="../../user/<?php echo $row['zone_id']; ?>">
                                                <img src="../<?php echo getProfile($row['zone_id']); ?>" class="h-36 object-cover rounded-md shadow-sm w-full">
                                            </a>
                                            <div class="pt-3 px-1">
                                                <a href="timeline.html" class="text-base font-semibold mb-0.5"> <?php echo getName($row['zone_id']); ?> </a>
                                                <p class="font-medium text-sm"> <?php echo getUsername($row['zone_id']); ?> </p>
                                                <button class="bg-blue-100 w-full flex font-semibold h-8 items-center justify-center mt-3 px-3 rounded-md text-blue-600 text-sm mb-1">
                                                    Remove
                                                </button>
                                            </div>
                            ...
                            <div class="flex-1">
                                ...
                                <nav class="responsive-nav style-2 md:m-0 -mx-4">
                                    <ul uk-switcher="connect: #photos-tab; animation: uk-animation-fade">
                                        <li><a href="#" class="lg:px-2"> All Events <span>0</span></a></li>
                                        <li><a href="#" class="lg:px-2"> by Clubs </a></li>
                                        <li><a href="#" class="lg:px-2"> by Societies </a></li>
                                        <li><a href="#" class="lg:px-2"> Upcoming </a></li>
                                        <li><a href="#" class="lg:px-2"> Ended </a></li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <nav class="responsive-nav border-b md:m-0 -mx-4">
                            <ul uk-switcher="connect: #clubs-tab; animation: uk-animation-fade">
                                <li><a href="#" class="lg:px-2"> Native Clubs </a></li>
                                <li><a href="#" class="lg:px-2"> Suggestions </a></li>
                            </ul>
                        </nav>

                        <div class="uk-switcher lg:mt-8 mt-4" id="clubs-tab">
                            ...
                            <div>
                                <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4 mt-5">
                                    ...
                                    $stmt = $link->prepare("SELECT * FROM `zone_clubs` WHERE `college_id` = ?");
                                    $stmt->bind_param("i", $_SESSION['college_id']);
                                    ...
                                    ?>
                                        ...
                                        <div class="card">
                                            <a href="../../club/<?php echo $row['club_id']; ?>">
                                                <img src="../<?php echo $row['profile']; ?>" class="h-36 object-cover rounded-t-md shadow-sm w-full">
                                            </a>
                                            <div class="p-3">
                                                <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> <?php echo $row['name']; ?> </a>
                                                <p class="font-medium text-sm"> <?php echo getTotal($row['club_id']); ?> Members</p>
                                                <button class="bg-blue-500 text-white w-full flex font-semibold h-8 items-center justify-center mt-3 px-3 rounded-md text-sm">
                                                    Remove
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <nav class="responsive-nav border-b md:m-0 -mx-4">
                            <ul uk-switcher="connect: #society-tab; animation: uk-animation-fade">
                                <li><a href="#" class="lg:px-2"> Native Societies </a></li>
                                <li><a href="#" class="lg:px-2"> Suggestions </a></li>
                            </ul>
                        </nav>

                        <div class="uk-switcher lg:mt-8 mt-4" id="society-tab">
                            ...
                            <div>
                                <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4 mt-5">
                                    ...
                                    $stmt = $link->prepare("SELECT * FROM `zone_societies` WHERE `college_id` = ?");
                                    $stmt->bind_param("i", $_SESSION['college_id']);
                                    ...
                                    ?>
                                        ...
                                        <div class="card">
                                            <a href="../../club/<?php echo $row['society_id']; ?>">
                                                <img src="../<?php echo $row['profile']; ?>" class="h-36 object-cover rounded-t-md shadow-sm w-full">
                                            </a>
                                            <div class="p-3">
                                                <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> <?php echo $row['name']; ?> </a>
                                                <p class="font-medium text-sm"> <?php echo getTotal($row['society_id']); ?> Members</p>
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <h2 class="text-xl font-semibold"> Webinars</h2>
                        <nav class="responsive-nav border-b">
