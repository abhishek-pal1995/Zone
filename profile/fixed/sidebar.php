    ...
    <div class="sidebar_inner" data-simplebar>
        ...
        <ul>
            ...
            <li><a href="#">
                    ...
                    </svg> <span> Upcoming Events </span></a>
            </li>
        ...
        <ul class="side_links" data-sub-title="Pages">
            ...
            <li><a href="#">
                    <ion-icon name="document-outline" class="side-icon"></ion-icon> <span> Create Content
                    </span>
                </a>
                <ul>
