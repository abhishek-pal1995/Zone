...
<head>
    ...
    <link href="<?php echo '../' . $clb_profile; ?>" rel="icon" type="image/png">
    ...
    <title>Zone |<?php echo " " . $clb_name; ?></title>
            ...
            <div class="mcontainer">
                ...
                <div class="profile user-profile">
                    ...
                    <div class="profiles_banner">
                        <img src="<?php echo '../' . $clb_banner; ?>" alt="">
                        <div class="profile_action absolute bottom-0 right-0 space-x-1.5 p-3 text-sm z-50 lg:flex">
                            <button onclick="window.location.hash = 'edit';" class="flex items-center justify-center h-8 px-3 rounded-md bg-gray-700 bg-opacity-70 text-white space-x-1.5">
                    ...
                    <div class="profiles_content">
                        ...
                        <div class="profile_avatar">
                            <div class="profile_avatar_holder">
                                <img src="<?php echo '../' . $clb_profile; ?>" alt="">
                            </div>
                        ...
                        <div class="profile_info">
                            <h1> <?php echo $clb_name; ?> </h1>
                            <p style="text-align: center;"> <?php echo $clb_uname; ?> </p>
                        </div>
                    ...
                    <div class="flex justify-between lg:border-t border-gray-100 flex-col-reverse lg:flex-row pt-2">
                        <nav class="responsive-nav pl-3">
                            <ul uk-switcher="connect: #timeline-tab; animation: uk-animation-fade">
                                ...
                                <li><a href="#">Members <span>3,243</span> </a></li>
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <nav class="responsive-nav border-b">
                            <ul uk-switcher="connect: #videos-tab; animation: uk-animation-fade">
                                <li><a href="#" class="lg:px-2"> Photos </a></li>
                                <li><a href="#" class="lg:px-2"> Videos </a></li>
                            </ul>
                        </nav>
