        ...
        <div class="header_inner mcontainer">
            ...
            <div class="header_search"><i class="uil-search-alt"></i>
                ...
                <div uk-drop="mode: click" class="header_search_dropdown">
                    ...
                    <h4 class="search_title"> Recent Searches </h4>
                    <ul>
                        <li>
                            <a href="#">
            ...
            <div class="right_side">
                ...
                <div class="header_widgets">
                    <a href="#" class="is_icon" uk-tooltip="title: Home">
                    ...
                    <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                        ...
                        <div class="drop_headline">
                            <h4> My Cart </h4>
                            <a href="#" class="btn_action hover:bg-gray-100 mr-2 px-2 py-1 rounded-md">
                                Checkout </a>
                        </div>
                    ...
                    <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                        ...
                        <a href="profile/<?php echo $login; ?>" class="user">
                            <div class="user_avatar">
                                <img src="assets/images/avatars/avatar-2.jpg" alt="">
                            </div>
                            <div class="user_name">

                                <div><?php if ($prefix == 'usr') {
                                            echo $usr_name;
                                        }
                                        if ($prefix == 'clg') {
                                            echo $clg_name;
