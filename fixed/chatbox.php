        ...
        <div class="relative pt-5 px-4">
            ...
            <div class="absolute right-3 top-4 flex items-center space-x-2">
                ...
                <a href="#" uk-toggle="target: #search;animation: uk-animation-slide-top-small">
                    <ion-icon name="search" class="text-xl hover:bg-gray-100 p-1 rounded-full md hydrated" role="img" aria-label="search"></ion-icon>
                </a>
                <a href="#">
                    <ion-icon name="settings-outline" class="text-xl hover:bg-gray-100 p-1 rounded-full md hydrated" role="img" aria-label="settings outline"></ion-icon>
                </a>
                <a href="#" aria-expanded="false" class="">
                    <ion-icon name="ellipsis-vertical" class="text-xl hover:bg-gray-100 p-1 rounded-full md hydrated" role="img" aria-label="ellipsis vertical"></ion-icon>
                </a>
